        ...
        if (isNewsletter) {
          ...
          await conn.sendMessage(from, {
            ...
            contextInfo: {
              ...
              externalAdReply: {
                title: "ᴅɪᴀʙʟᴇssᴇ_ᴠ1 RUNTIME",
                body: "ᴅɪᴀʙʟᴇssᴇ_ᴠ1 runtime information ",
                thumbnailUrl: "https://files.catbox.moe/hrpf0i.jpg",
                sourceUrl: "https://github.com/🌺ᴅɪᴀʙʟᴇssᴇ🍒/Matsu",
                mediaType: 1,
